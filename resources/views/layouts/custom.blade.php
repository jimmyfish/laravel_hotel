            ...
            <div class="container-fluid">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-hover earning-box">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="width:50px;"><span class="round"><img src="images/users/8.jpg" alt="user" width="50"></span></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><span class="round round-success"><img src="images/users/1.jpg" alt="user" width="50"></span></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><span class="round round-primary"><img src="images/users/4.jpg" alt="user" width="50"></span></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><span class="round round-warning"><img src="images/users/5.jpg" alt="user" width="50"></span></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><span class="round round-danger"><img src="images/users/1.jpg" alt="user" width="50"></span></td>
                                                <td>
                                ...
                                <div class="chat-box">
                                    ...
                                    <ul class="chat-list">
                                        ...
                                        <li class="reverse">
                                            ...
                                            <div class="chat-img"><img src="images/users/5.jpg" alt="user" /></div>
                                            <div class="chat-time">10:57 am</div>
                                        </li>
                                        <!--chat Row -->
                                        <li class="reverse">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3">
                        <!-- Column -->
                        <div class="card">
                            <img class="card-img-top" src="images/background/profile-bg.jpg" alt="Card image cap">
                        ...
                        <!-- Column -->
                        <div class="card">
                            <div class="card-body bg-inverse" style="background: url(images/background/user-info.jpg) / cover;">
