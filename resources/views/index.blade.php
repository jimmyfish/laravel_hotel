...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-lg-4">
            <!-- Column -->
            <div class="card"> <img class="card-img-top" src="images/background/profile-bg.jpg" alt="Card image cap" style="max-height: 165px;">
                <div class="card-body little-profile text-center">
                    <div class="pro-img"><img src="images/users/4.jpg" alt="user" /></div>
                    <h3 class="m-b-0">Jimmy Fish</h3>
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="d-flex  p-l-20 bg-light align-items-center flex-row ">
                    ...
                    <div class="p-2">
                        <h3 class="m-b-0">Saturday</h3><small>Malang, ID</small></div>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card">
                <img class="card-img-top img-responsive" src="images/big/img1.jpg" alt="Card image cap">
                <div class="card-body">
        ...
        <div class="col-lg-4">
            <div class="card">
                <img class="card-img-top img-responsive" src="images/big/img2.jpg" alt="Card image cap">
                <div class="card-body">
                    <ul class="list-inline font-14">
                        <li class="p-l-0">20 May 2016</li>
                        <li><a href="javascript:void(0)" class="link">3 Comment</a></li>
        ...
        <div class="col-lg-4">
            <div class="card">
                <img class="card-img-top img-responsive" src="images/big/img4.jpg" alt="Card image cap">
                <div class="card-body">
                    <ul class="list-inline font-14">
                        <li class="p-l-0">20 May 2016</li>
                        <li><a href="javascript:void(0)" class="link">3 Comment</a></li>
